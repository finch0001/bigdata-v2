...
import com.yee.bigdata.common.util.SystemTime;
    ...
    public ByteBuffer allocate(int size, long maxTimeToBlockMs) throws InterruptedException {
        ...
        try {
            ...
            if (this.availableMemory + freeListSize >= size) {
                ...
                // satisfy the request
                // 为了让availableMemory + freeListSize >= size, freeUp()方法会从free队列中不断释放
                ...
                // 解锁
                lock.unlock();
                // 这里没有使用后free队列中的buffer,而是直接分配size大小的HeapByteBuffer
