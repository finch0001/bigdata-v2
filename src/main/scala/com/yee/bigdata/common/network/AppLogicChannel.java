...
import com.yee.bigdata.common.network.TransportLayer;
import com.yee.bigdata.common.util.ClientUtils;

public class AppLogicChannel {
    ...
    public AppLogicChannel(String id, TransportLayer transportLayer, Authenticator authenticator, int maxReceiveSize) throws IOException {
        this.id = id;
    ...
    public void close() throws IOException {
        ClientUtils.closeAll(transportLayer, authenticator);
    }
